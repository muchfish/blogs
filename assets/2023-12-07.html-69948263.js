...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,1),z={id:"修改config-ts",tabindex:"-1"},C=n("a",{class:"header-anchor",href:"#修改config-ts","aria-hidden":"true"},"#",-1),D={href:"https://github.com/muchfish/my-docs/blob/master/src/.vuepress/config.ts",target:"_blank",rel:"noopener noreferrer"},B=i(`<div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token function">defineUserConfig</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
